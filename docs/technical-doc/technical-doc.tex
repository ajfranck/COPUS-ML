...
\textbf{Q: What video formats are supported?}\\
A: MP4, AVI, MOV directly. MTS auto-converts to MP4.

\textbf{Q: Can I modify the 2-minute interval?}\\
A: Yes, change \texttt{AGGREGATION\_INTERVAL} in \texttt{full\_lecture\_evaluation.py}.

\textbf{Q: How to interpret confidence scores?}\\
A: 1.0 = high confidence, 0.5-0.99 = medium, 0.25-0.49 = low (filtered out), <0.25 = "Houston, we have a problem".
